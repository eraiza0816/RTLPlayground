...
var LANG = {
  en: {
    ...
    eee_port: 'Port',
    eee_active: 'Active?',
    eee_sfp_note: 'SFP ports do not support EEE',
    ...
    sfp_save: 'Save Backup',
    sfp_restore: 'Restore Backup',
    sfp_patch: 'Patch FC→Eth',
    sfp_fixsum: 'Fix Checksum',
    sfp_vendor: 'Vendor:',
    sfp_pn: 'PN:',
    sfp_sn: 'SN:',
    sfp_type: 'Type:',
    sfp_byte: 'Byte',
    sfp_updated: 'updated.',
    sfp_invalid_value: 'Invalid value',
    sfp_edit_byte: 'Edit byte',
    sfp_patch_confirm: 'patch EEPROM (FC→Ethernet)?',
    sfp_patch_done: 'Patch complete.',
    sfp_fix_confirm: 'fix checksums?',
    sfp_fix_done: 'Checksums fixed.',
    sfp_save_confirm: 'save EEPROM to flash backup?',
    sfp_save_done: 'Saved to flash.',
    sfp_restore_confirm: 'restore EEPROM from flash backup?',
    sfp_restore_done: 'Restored.',
    sfp_clone: 'Clone from Flash',
    sfp_clone_confirm: 'clone EEPROM from flash buffer (load via bulk upload or restore first)?',
    sfp_clone_done: 'Cloned.',
    sfp_write_confirm: 'write file to EEPROM? (takes about a minute)',
    sfp_writing: 'Writing ',
    sfp_write_stall: 'Still writing — verify in the editor before retrying.',
    sfp_verify_fail: 'Verify failed.',
    sfp_identical: 'Already identical, nothing to do.',
    sfp_write_fail: 'Write failed at byte ',
    sfp_write_done: 'Write complete.',
    sfp_bad_size: 'File must be exactly 256 bytes.',
    sfp_load_fail: 'Failed to load EEPROM.',
    sfp_bad_pw: 'Password must be 8 hex digits.',
    sfp_page: 'Page:',
    sfp_a2: 'A2h Diagnostics',
    sfp_readonly: 'Diagnostics page is read-only: switch back to A0h EEPROM.',
    sfp_temperature: 'Temperature',
    sfp_voltage: 'Voltage',
    sfp_tx_bias: 'TX Bias',
    sfp_tx_power: 'TX Power',
    sfp_rx_power: 'RX Power',
  ...
  ja: {
    ...
    eee_port: 'ポート',
    eee_active: '有効?',
    eee_sfp_note: 'SFP ポートは EEE に対応していません',
    eee_enable: 'EEE 有効化',
    eee_disable: 'EEE 無効化',
    eee_on: 'オン',
    eee_off: 'オフ',
    ...
    sfp_slot: 'スロット:',
    sfp_refresh: '更新',
    sfp_download: '.binをダウンロード',
    sfp_upload: '.binをアップロード',
    sfp_save: 'バックアップ保存',
    sfp_restore: 'バックアップ復元',
    sfp_patch: 'FC→Ethパッチ',
    sfp_fixsum: 'チェックサム修正',
    sfp_vendor: 'ベンダー:',
    sfp_pn: 'PN:',
    ...
    sfp_byte: 'バイト',
    sfp_updated: '更新しました。',
    sfp_invalid_value: '無効な値です。',
    sfp_edit_byte: 'バイトを編集',
    sfp_patch_confirm: 'EEPROMにパッチ(FC→Ethernet)しますか?',
    sfp_patch_done: 'パッチしました。',
    sfp_fix_confirm: 'チェックサムを修正しますか?',
    sfp_fix_done: 'チェックサムを修正しました。',
    sfp_save_confirm: 'EEPROMをフラッシュに保存しますか?',
    sfp_save_done: 'フラッシュに保存しました。',
    sfp_restore_confirm: 'フラッシュからEEPROMを復元しますか?',
    sfp_restore_done: '復元しました。',
    sfp_clone: 'フラッシュから複製',
    sfp_clone_confirm: 'フラッシュバッファからEEPROMを複製しますか?（先にbulkアップロードか復元で読み込む必要があります）',
    sfp_clone_done: '複製しました。',
    sfp_write_confirm: 'ファイルをEEPROMに書き込みますか?（1分ほどかかります）',
    sfp_writing: '書込中 ',
    sfp_write_stall: 'まだ書込中です — 再試行の前にエディタで確認してください。',
    sfp_verify_fail: '検証失敗。',
    sfp_identical: '既に同一です。何もしません。',
    sfp_write_fail: 'バイトで書込失敗: ',
    sfp_write_done: '書き込み完了。',
    sfp_bad_size: 'ファイルは256バイトである必要があります。',
    sfp_load_fail: 'EEPROMの読み込みに失敗しました。',
    sfp_bad_pw: 'パスワードは16進8桁です。',
    sfp_page: 'ページ:',
    sfp_a2: 'A2h 診断情報',
    sfp_readonly: '診断ページは読み取り専用です。A0h EEPROMに戻してください。',
    sfp_temperature: '温度',
    sfp_voltage: '電圧',
    sfp_tx_bias: 'TXバイアス',
    sfp_tx_power: 'TX出力',
